...
CASEIDS = [1, 2, 5, 6, 7, 8, 9, 12, 13, 25, 26, 27, 29, 37, 49, 54, 57, 62] 
...
def main():
    ...
    p_sp_rlwmi_l, f_sp_rlwmi = optsp.search_solution_all_scipy(models.model_rlwmi, optsp.bounds_rlwmi, session_list, n_reps=OPT_REPS, models_path=MODEL_PATH)

    p_sp_rlwmi = optsp.param_list_dict(models.model_rlwmi, p_sp_rlwmi_l)
    optimization.save_param_dict(os.path.join(OUTPUT_PATH, 'param_sp_rlwmi.xls'), p_sp_rlwmi, f_sp_rlwmi)
